...
void MainWindow::on_pushButton_Connect_clicked()
{
    if (ui->pushButton_Connect->text() == "Connect")
    {
        ...
        {
            QMessageBox::critical(this, "Client2", "Missing ':' in IP:Port");
            return;
        }
        ...
        {
            QMessageBox::critical(this, "Client2", "Invalid Port, must be 0..65535");
            return;
        }
        QHostAddress adr;
        if (adr.setAddress(split[0]) == false)
        {
            QMessageBox::critical(this, "Client2", "Invalid IP Address");
            return;
        }
        if (ui->lineEditFile->text() == "")
        {
            QMessageBox::critical(this, "Client2", "File name is <empty>");
            return;
        }
        QFileInfo fileInfo(ui->lineEditFile->text());
        if (!fileInfo.exists() || !fileInfo.isFile())
        {
            QMessageBox::critical(this, "Client2",
        ...
        {
            QMessageBox::critical(this, "Client2", "Invalid interval, must be 0..99999");
            return;
        }
